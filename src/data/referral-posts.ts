...
export const referralBids: ReferralBid[] = [
  // Bids on rp-1 (Charlotte)
  {
    ...
    videoDuration: 74,
    highlights: ['14 corporate relocations this year', 'SouthPark specialist', 'Compass Concierge available', '86 RCS'],
    status: 'pending',
  ...
  },
  {
    ...
    videoUrl: null,
    videoDuration: null,
    highlights: ['6 Ballantyne closings in 12 months', 'School district expert', '87 RCS'],
    status: 'pending',
  ...
  },
  {
    ...
    videoDuration: 62,
    highlights: ['Same brokerage — Real Broker', '9 years in SouthPark', 'Kids in local schools', '87 RCS'],
    status: 'pending',
  ...
  // Bids on rp-3 (Grand Rapids)
  {
    ...
    videoDuration: 85,
    highlights: ['#1 in East GR 3 years', 'First-time buyer specialist', '91 RCS', '< 30min response'],
    status: 'pending',
  ...
  },
  {
    ...
    videoDuration: 58,
    highlights: ['Adjacent territory expert', 'Chicago-to-MI relocation experience', '92 RCS', 'Homes for Heroes certified'],
    status: 'pending',
  ...
  // Bids on rp-5 (Scottsdale luxury)
  {
    ...
    videoDuration: 92,
    highlights: ['$47M in PV luxury sales', 'Off-market inventory access', 'Builder relationships', '91 RCS'],
    status: 'pending',
  ...
  },
  {
    ...
    videoDuration: 78,
    highlights: ['80% PV gated communities', 'Entertainment industry clients', 'NDA-standard discretion', '92 RCS'],
    status: 'pending',
  ...
  // Awarded bid on rp-6 (Nashville — already completed)
  {
    ...
    videoDuration: 55,
    highlights: ['3 physician relocations this quarter', '12 homes ready to show', 'Franklin/Brentwood specialist', '95 RCS'],
    status: 'accepted',
...
export function getBidsForPost(postId: string): ReferralBid[] {
  return referralBids
    ...
    .sort((a, b) => b.agentRCSScore - a.agentRCSScore)
}
