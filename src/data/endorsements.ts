...
export const endorsements: Endorsement[] = [
  ...
  { id: 'end-1', agentId: 'ashley', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Fast Closer', date: '2025-03-10' },
  { id: 'end-2', agentId: 'ashley', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Excellent Communicator', date: '2025-03-10' },
  ...
  { id: 'end-12', agentId: 'carlos', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Fast Closer', date: '2025-01-20' },

  // Darius King endorsements
  { id: 'end-13', agentId: 'darius', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'New Construction Expert', date: '2025-02-22' },
  { id: 'end-14', agentId: 'darius', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Market Knowledge', date: '2025-02-22' },
  ...
  { id: 'end-21', agentId: 'rachel', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Luxury Buyers', date: '2025-03-01' },
  ...
  { id: 'end-25', agentId: 'tanya', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Excellent Communicator', date: '2025-02-15' },
  { id: 'end-26', agentId: 'tanya', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Responsive & Reliable', date: '2025-02-15' },

  // Jason Smith endorsements (received from partners)
  ...
  { id: 'end-34', agentId: 'megan', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Luxury Buyers', date: '2025-02-15' },
  { id: 'end-35', agentId: 'megan', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Market Knowledge', date: '2025-02-15' },
  ...
  { id: 'end-39', agentId: 'marcus', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Luxury Buyers', date: '2025-01-05' },
  ...
  { id: 'end-42', agentId: 'victoria', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Market Knowledge', date: '2025-03-12' },

  // Canadian agent endorsements
  { id: 'end-43', agentId: 'sarah_t', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Cross-Border Expert', date: '2025-03-08' },
  { id: 'end-44', agentId: 'sarah_t', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Great with Relocations', date: '2025-03-08' },
  ...
  { id: 'end-46', agentId: 'david_w', endorserId: 'jason', endorserName: "Jason Smith", endorserBrokerage: 'Sweet Home Realty', endorserColor: '#f0a500', skill: 'Cross-Border Expert', date: '2025-03-01' },
